    ...
    return (
        <div>
            ...
            <form
              ...
              className="mt-10 flex flex-wrap items-end gap-4 font-montserrat"
            >
              {/* destination input*/}
              ...
              <div className="flex flex-col">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-98 rounded-xl border border-gray-300 bg-white py-3 pl-10 pr-4 font-montserrat text-black text-base placeholder-gray-500 focus:border-blue-900 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex pl-6">
                <button
                  type="submit"
                  className="h-[44px] rounded-2xl bg-[#010a46] px-10 font-montserrat text-xl font-medium text-white shadow-md transition transform hover:-translate-y-1 hover:bg-[#0048a4] active:translate-y-0 hover:cursor-pointer"
                >
                  Let’s go!
                </button>
              </div>
